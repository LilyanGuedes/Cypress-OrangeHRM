...
describe('Orange HRM Tests', () => {
  ...
  it.only('User info update - Success', () => {
    ...
    cy.get(selectorList.genericField).eq(5).clear().type("1111")
    cy.get(selectorList.genericField).eq(6).clear().type("2222")
    cy.get(selectorList.genericField).eq(7).clear().type("2035-01-01")
